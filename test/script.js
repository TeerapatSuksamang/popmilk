...
// window.onload = () => {
    startTimer();
// };
equipped = JSON.parse(localStorage.getItem("equippedItems")) || {};
catSkin = equipped.cat || "c_p"; // ✅ ใช้ตัวแมวที่เลือก
    ...
    let fallInterval = setInterval(() => {
        ...
        if (itemBottom >= catTop && itemBottom <= catTop + 5 && 
            ...
            if (item.dataset.type === "milk") {
                ...
                let equippedNow = JSON.parse(localStorage.getItem("equippedItems")) || {};
                let catSkinNow = equippedNow.cat || "c_p";
            
                cat.src = "img/" + catSkinNow + "_open.png";
                setTimeout(() => {
                    cat.src = "img/" + catSkinNow + ".png";
                }, 250);
...
function endGame(type) {
    ...
    setTimeout(() => {
        ...
        cat_cry.src = "img/" + catSkinNow + "_cry.png";
