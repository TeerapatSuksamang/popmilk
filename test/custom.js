...
function updateEquippedItems() {
    ...
    document.getElementById("cat1").src = "img/" + equippedItems.cat + ".png";
    document.getElementById("hat1").src = equippedItems.hat !== "hat_none" ? "img/" + equippedItems.hat + ".png" : "";
    document.getElementById("eye1").src = equippedItems.glasses !== "gl_none" ? "img/" + equippedItems.glasses + ".png" : "";
